...
void ConVar::InternalSetValue(const char *value)
{
	...
	auto temp = *(uintptr_t*)&m_Value.m_fValue ^ (uintptr_t)this;
	...
	// Redetermine value
	*(uintptr_t*)&m_Value.m_fValue = *(uintptr_t*)&fNewValue ^ (uintptr_t)this;
	*(uintptr_t*)&m_Value.m_nValue = (uintptr_t)fNewValue ^ (uintptr_t)this;
...
{
	if (nValue == ((int)m_Value.m_nValue ^ (uintptr_t)this))
		return;
	...
	// Redetermine value
	float flOldValue = m_Value.m_fValue;
	*(uintptr_t*)&m_Value.m_fValue = *(uintptr_t*)&fValue ^ (uintptr_t)this;
	*(uintptr_t*)&m_Value.m_nValue = *(uintptr_t*)&nValue ^ (uintptr_t)this;
	...
	bool bMax /*= false*/, float fMax /*= false*/, FnChangeCallback_t callback /*= NULL*/)
{
	...
	*(uintptr_t*)&m_Value.m_fValue = *(uintptr_t*)&value ^ (uintptr_t)this;
	*(uintptr_t*)&m_Value.m_nValue = *(uintptr_t*)&value ^ (uintptr_t)this;

...
namespace valvegen
{
	...
	public:
		...
		DataElement* CreateDataElement(uintptr_t offset, std::string name, DATA_TYPE dtype, uintptr_t stride = 0);
		...
		/// <param name="dtype">The dtype.</param>
		/// <returns>valvegen.DataElement *.</returns>
		DataElement* CreateDataElementClassInstance(uintptr_t offset, std::string name, std::string varname, DATA_TYPE dtype);
		...
		/// </summary>
		/// <param name="index">The index.</param>
		/// <returns>uintptr_t.</returns>
		uintptr_t GetInheritedClassSize(UINT index = 0);
